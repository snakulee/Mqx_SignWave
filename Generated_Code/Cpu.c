...
void PE_low_level_init(void)
{
  ...
  (void)IO1_Init(NULL);
  /* ### DAC_LDD "DrvDac2V" component auto initialization. Auto initialization feature can be disabled by component's property "Auto initialization". */
  (void)DrvDac2V_Init(NULL);
}
